...
function updateHeader() {
    ...
    // Header siempre visible - sin hide/show
...
// Lazy loading deshabilitado para carga inmediata - código removido para producción
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', function (e) {
        ...
        if (target) {
            // Offset automático: calcula la altura real del header dinámicamente
            const header = document.querySelector('.header');
