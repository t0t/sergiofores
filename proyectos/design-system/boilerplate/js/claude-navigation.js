...
class ClaudeNavigation {
    constructor(options = {}) {
        this.config = {
            ...
            menuSelector: '.menu__list, #main-nav-list',
            menuContainerSelector: '.menu, #main-menu',
    ...
    /**
     * Configurar mobile toggle navigation
     */
    setupMobileToggle() {
        if (!this.toggleButton || !this.menu || !this.menuContainer) {
            console.warn('ClaudeNavigation: Mobile toggle elements not found');
            return;
        }
        ...
        document.addEventListener('keydown', (e) => {
            if (e.key === 'Escape' && this.isMenuOpen) {
                this.closeMobileMenu();
                this.toggleButton.focus(); // Devolver foco al toggle
            }
        });
        ...
        console.log('ClaudeNavigation: Mobile toggle initialized');
        
        // Verificación final de funcionamiento
        setTimeout(() => {
            console.log('✅ ClaudeNavigation: Toggle móvil listo y funcionando');
        }, 100);
    }
    ...
    openMobileMenu() {
        ...
        this.menuContainer.classList.add(this.config.menuOpenClass);
        this.toggleButton.setAttribute('aria-expanded', 'true');
        this.toggleButton.classList.add('menu__toggle--active');
        
        // Enfocar primer link para accesibilidad
        const firstLink = this.menu.querySelector('.menu__link');
        if (firstLink) {
        ...
        // console.log('ClaudeNavigation: Mobile menu opened');
    }
    ...
    closeMobileMenu() {
        this.isMenuOpen = false;
        this.menuContainer.classList.remove(this.config.menuOpenClass);
        this.toggleButton.setAttribute('aria-expanded', 'false');
        this.toggleButton.classList.remove('menu__toggle--active');
        
        // Restaurar scroll del body
        document.body.style.overflow = '';
        
        // console.log('ClaudeNavigation: Mobile menu closed');
    }
